...
/* 
 * $Id: ASelectSAMException.java,v 1.7 2006/05/03 09:30:33 tom Exp $ 
 * 
 * Changelog:
 * $Log: ASelectSAMException.java,v $
 ...
 * <br>
 * <b>Description: </b> <br>
 * This exception is thrown if SAM fails. <br>
 * <br>
 ...
 * @author Alfa & Ariss
 */
public class ASelectSAMException extends ASelectException
{
	 ...
	 * <br>
	 * <b>Description: </b> <br>
	 * Creates and initializes a new <code>ASelectSAMException<code>
	 * with the given code.
	 * <br><br>
	 ...
	 *            The error code.
	 */
	public ASelectSAMException(String sCode) {
		super(sCode);
	}
	 ...
	 * <br>
	 * <b>Description: </b> <br>
	 * Creates a new <code>ASelectSAMException</code> with the given code and cause. <br>
	 * <br>
	 * <b>Concurrency issues: </b> <br>
	 * -<br>
	 * <br>
	 ...
	 *            the error cause.
	 */
	public ASelectSAMException(String sCode, Throwable tCause) {
		super(sCode, tCause);
	}
}