 ...
 * <br>
 * <b>Description:</b> <br>
 * Contains the parsed authorization rules as well as the <code>String</code> representation and the URI.<br>
 * <br>
...
{
	/**
	 * The URI that this rule belongs to. This URI can contain wildcards.
	 */
	...
	/**
	 * Create a new <code>AuthorizationRule</code>. <br>
	 * 
	 * @param sPlainTextRule
	 *            The rule in plain text.
	 * @param sURI
	 *            The request URI for this rule.
	 * @param tEvaluation
	 *            The parsed evaluation rule.
	 */
