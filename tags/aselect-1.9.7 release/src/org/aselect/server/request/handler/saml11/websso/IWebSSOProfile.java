 ...
 * <br>
 * <b>Description:</b><br>
 * Interface that describes the methods that a WebSSO Profile response handler class must implement <br>
 * <br>
...
public interface IWebSSOProfile
{
	...
	/**
	 * Initializes the profile handler. <br>
	 * <br>
	 * <b>Description:</b> <br>
	 * Reads configuration and sets class variables to a default value <br>
	 * <br>
	 * <b>Concurrency issues:</b> <br>
	 * - <br>
	 * <br>
	 ...
	 * 
	 * @param oConfig
	 *            object containing the configuration used by the A-Select ConfigManager
	 * @param lAssertionExpireTime
	 *            the configured assertion expire time
	 * @param sAttributeNamespace
	 *            the configured attribute namespace that will be used for creating attributes
	 * @param bSendAttributeStatement
	 *            TRUE if the Attribute Statement must be send direclty
	 ...
	 * <br>
	 * <b>Description:</b> <br>
	 * Sends a SAML 1.1 WebSSO response <br>
	 * <br>
	 * <b>Concurrency issues:</b> <br>
	 * - <br>
	 * <br>
	 ...
	 * 
	 * @param htInfo
	 *            containing the A-Select verify_credentials response items
	 * @param response
	 *            the HttpServletResponse were to the SAML response will be sent
	 * @param sIP
	...
	/**
	 * Returns the value of the configured id parameter in the profile section. <br>
	 * <br>
	 * <b>Description:</b> <br>
