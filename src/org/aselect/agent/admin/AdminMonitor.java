...
/**
 * Implements a GUI for monitoring tickets that are issued by the A-Select
 * Agent. 
 * <br><br>
 * <b>Description: </b> 
 * <br>
 * This class implements a convenient GUI implemented as a JFrame for monitoring
 * sessions and tickets that are issued by the A-Select Agent. 
 * This tool can also be used to shutdown the A-Select Agent service. <br>
 * <br>
 * This class uses Models for implementing the data providers for the current
 * sessions and tickets. 
 * <br><br>
 * <i>
 * Note: This class works only when there is a graphics display found.
 * This means that if the A-Select Agent runs as a service in Windows, this tool
 * won't run. Same applies to console mode terminals for other platforms.
 * </i>
 * <br><br>
...
public class AdminMonitor extends JFrame implements TableModelListener
{
     ...
     * <b>Description: </b> 
     * <br>
     * This method starts up the GUI by initializing the complete JFrame and all
     * fields and initializing the models. <br>
     * <br>
     * <b>Concurrency issues: </b> 
     * <br>
     * None. <br>
     ...
     * A-Select Agent must have been started in console mode and a graphics
     * display adapter is available. <br>
     * <br>
     * <b>Postconditions: </b> 
     * <br>
     * None. <br>
     ...
     * <br>
     * <b>Description: </b> <br>
     * This method stops the GUI monitor by disposing the GUI and shutting down
     * the monitor models. <br>
     * <br>
    ...
    public void stop()
    {
        ...
        ASelectAgentSystemLogger.getHandle()
            .log(Level.INFO, MODULE, sMethod, "AdminMonitor stopped.");
    }
    ...
    public void paint(Graphics xGraphics)
    {
        ...
        _killTicketButton.setBounds((xWidth - _buttonWidth) / 2, y,
        ...
        _killAllTicketsButton.setBounds(xWidth - _buttonWidth - 8, y,
            _buttonWidth, _buttonHeight);

        _stopAgentButton.setBounds(xWidth - _buttonWidth - 8, y + _buttonHeight
            + 20, _buttonWidth, _buttonHeight);

        x = 8;
        y -= 20;
        _numberOfSessionsLabel
            .setBounds(x, y, _stopAgentButton.getX() - 10, 20);
    ...
    /**
     * ActionListener for the Kill Ticket Button implemented as an inner class.
     * <br>
     * <br>
     * <b>Description: </b> <br>
     * Trivial. <br>
    ...
    class KillButtonListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            try
            {
                ...
                {
                    xTicketManager.killTicket((String)_ticketsMonitorModel
                        .getValueAt(xRows[i], _ticketsMonitorModel
                            .getColumnCount()));
                }
            }
            catch (Exception x)
    ...
    /**
     * ActionListener for the Kill All Tickets Button implemented as an inner
     * class. 
     * <br><br>
     * <b>Description: </b> <br>
     * Trivial. <br>
    ...
    /**
     * ActionListener for the Stop Agent Button implemented as an 
     * inner class.
     * <br>
     * <br>
     * <b>Description: </b> <br>
    ...
    {
        /**
         * Stops the A-Select Agent by sending a <code>request=stop</code>
         * command to the A-Select Agent. <br>
         * <br>
         * 
         * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
         */
        public void actionPerformed(ActionEvent e)
        {
            try
            {
                ASelectAgentConfigManager xASelectAgentConfigManager = ASelectAgentConfigManager
                    .getHandle();
                Object objAgentSection = xASelectAgentConfigManager.getSection(
                    null, "agent");
                String xPort = xASelectAgentConfigManager.getParam(
                    objAgentSection, "adminport");

                Socket xSocket = new Socket("127.0.0.1", Integer
                    .parseInt(xPort));
                PrintStream xOutput = new PrintStream(xSocket.getOutputStream());
                BufferedReader xInput = new BufferedReader(
    ...
    /**
     * BasicWindowAdapter that couples to the GUI. 
     * <br>
     * <br>
     * <b>Description: </b> <br>
