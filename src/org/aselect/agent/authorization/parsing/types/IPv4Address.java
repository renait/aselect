...
{   
     ...
     */
    public IPv4Address(String s) throws Exception
    {
        String sAdress = null;
     ...
     * 	is not an <code>IPv4Address</code>.
     */
    public int compareTo(Object oOther) throws ClassCastException
    {
        ...
        if(oOther instanceof IPv4Address)
        {
            ...
            for(int i = 0; i < 4 && bOk; i++)
            {
                ...
                bOk = (aOther._baAddress[i] & this._baMask[i]) 
                	== this._baAddress[i];
            }
        ...
        else
        {
            throw new ClassCastException(
                "IPv4Address objects are only comparable to other IPv4Address objects");
        }
        return iRet;
    }
     ...
     * @param bIsMask <code>true</code> if address is a subnet mask.
     * @return The address as a <code>byte[]</code>.
     * @throws NumberFormatException If parsing fails.
     */
    private byte[] convertAddress(String s, boolean bIsMask) throws NumberFormatException
    {
