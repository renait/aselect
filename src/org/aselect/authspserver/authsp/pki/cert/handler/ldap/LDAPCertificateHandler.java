...
public class LDAPCertificateHandler implements ICertificateHandler
{
	 ...
	 * @see org.aselect.authspserver.authsp.pki.cert.handler.ICertificateHandler#init(org.aselect.authspserver.log.AuthSPSystemLogger, java.lang.Object)
	 */
	public void init(AuthSPSystemLogger oSystemLogger, Object oBackendConfig) throws ASelectException
	{
        ...
        try
        {
            _sPrincipalDn = _oConfigManager.getParam(oBackendConfig,
                "principal_dn");
            _sPrincipalPassword = _oConfigManager.getParam(oBackendConfig,
                "principal_password");
        }
        catch (ASelectConfigException e)
        {
	 ...
	 */
	public KeyStore getCertificates(String sSubjectDn) throws ASelectException
	{
		...
		{
			_systemLogger.log(Level.WARNING, MODULE, sMethod, "Internal error occured by creating instance of JKS KeyStore", e);
		...
		if(_sDriver == null || _sLdapMethod == null || _sUrl == null || 
				_sBaseDn == null || _sCertificateAttrName == null )
		{
		...
		try
		{
			...
			String[] saAttrIds = {_sCertificateAttrName};
