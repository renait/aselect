 ...
 * <br>
 * <b>Description:</b><br>
 * This interface contains methods to access data and control information of the request. <br>
 * <br>
...
public interface IProtocolRequest
{
	...
	/**
	 * Get a property of the underlying protocol. <br>
	 * <br>
	 * <b>Description:</b> <br>
	 * Returns the property value with the given name. For e.g. HTTP these properties are headers like "content-type". <br>
	 * <br>
	 * <b>Concurrency issues:</b> <br>
	 * - <br>
	 * <br>
	...
	/**
	 * get the request its data. <br>
	 * <br>
	 * <b>Description:</b> <br>
	 * Returns an <code>InputStream</code>, which contains the request its data. <br>
	 * <br>
	 * <b>Concurrency issues:</b> <br>
	 * The returned <code>InputStream</code> should not be shared. <br>
	 * <br>
	 * <b>Preconditions:</b> <br>
	 * - <br>
	 * <br>
