 ...
 * <b>Description: </b> 
 * <br>
 * The <code>IStorageHandler</code> interface defines a generic interface for
 * all StorageHandlers in the StorageManager. A IStorageHandler handles the
 * physical access to the storage. <br>
 * <br>
...
public interface IStorageHandler
{
     ...
     *          parameters for the IStorageHandler can be found.
     ...
     * @throws ASelectStorageException If initialisation fails.
     */
     ...
     * -
     * <br>
     * @param oKey The identifier of the object that needs to be stored.
     ...
     * <br>
     * @param oKey The identifier of the object that needs to be stored.
     * @param oValue The object that needs to be stored.
     * @param lTimestamp The time at which the object is stored.
     * @throws ASelectStorageException If storing fails.
     */
     ...
     * <br>
     * @param oKey The identifier of the object that needs to be removed.
     * @throws ASelectStorageException If removal fails.
     */
     ...
     * <b>Preconditions:</b>
     * <br>
     * <code>lTimestamp != null</code>
     * <br><br>
     * <b>Postconditions:</b>
     * <br>
     * All object which expire before or at the given time are removed.
     * <br>
     * @param lTimestamp The expiration time.
     * @throws ASelectStorageException If cleaning fails.
     */
     ...
     * <br><br>
     * @param lItemCount number of items that will be checked if it is the maximum
