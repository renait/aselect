...
{
    /**
     * Initializes the <code>ConfigHandler</code>.
     * <br>br>
     * <b>Description: </b> <br>
     * Initializes the <code>ConfigHandler</code> using a <code>File</code>
     * as source. <br>
     * <br>
     * <b>Concurrency issues: </b> <br>-<br>
     * <br>
     ...
     * <br><br>
     * <b>Description: </b> <br>
     * Initializes the <code>ConfigHandler</code> using a database as source.
     * <br>
     * <br>
     * <b>Concurrency issues: </b> <br>-<br>
     * <br>
     ...
     * <b>Description: </b> 
     * <br>
     * The sub-section is of the given type and has the given section ID. The
     * root section can be null: the first section will be returned. The
     * requested section ID must be a <code>String</code> containing one '='
     * character (syntax: [param]=[value]). <br>
     * <br>
     * <b>Concurrency issues: </b> <br>-<br>
     * <br>
     ...
     * <br>
     * <b>Preconditions: </b> <br>
     * If the root section is <code>null</code>: the first section will be
     * returned. <br>
     * <br>
     * <b>Postconditions: </b> <br>-<br>
     * 
     ...
     *             If setting fails.
     */
    public boolean setParam(Object oSection, String sConfigItem,
        String sConfigValue, boolean bMandatory) throws ASelectConfigException;
     ...
     * after the given section. It will return <code>null</code> if no next
     * section can be found. <br>
     * <br>
     * <b>Concurrency issues: </b> <br>-<br>
     * <br>
     * <b>Preconditions: </b> <br>-<br>
     ...
     *             If retrieving fails
     */
    public Object getNextSection(Object oSection) throws ASelectConfigException;
     ...
     * -
     * <br>
     * @throws ASelectConfigException If saving fails
     */
     ...
     * in the <code>ConfigHandler</code>.<br>
     * <br>
     * <b>Concurrency issues: </b> <br>-<br>
     * <br>
     * <b>Preconditions: </b> <br>
     ...
     */
    public void importConfig(File fConfig) throws ASelectConfigException;
