...
public class ConfigManager
{
            ...
            {//only start initializing when config file exists
                ...
                else
                {
                    ...
                    throw new ASelectConfigException(
                        Errors.ERROR_ASELECT_CANT_OPEN);
                }
            }
            else
            {
                ...
                throw new ASelectConfigException(
                    Errors.ERROR_ASELECT_NOT_FOUND);
            }
        }
     ...
     *             If initialization fails.
     */
    public void init(String sDriverName, String sUser, String sPassword,
        String sDatabaseURL, String sDatabaseTable, String sConfigId,
        SystemLogger oSystemLogger) throws ASelectConfigException
    {
        StringBuffer sbError = new StringBuffer();
        String sMethod = "init()";
        ...
        try
        {
            ...
            if (sDriverName == null || sUser == null || sPassword == null
                || sDatabaseURL == null || sDatabaseTable == null
                || sConfigId == null)
            {
            ...
            if (_oConfigHandler != null)
            {
                _oConfigHandler.init(sUser, sPassword, sDatabaseURL,
                    sDatabaseTable, sDriverName, sConfigId);
            }
            else
            {
    ...
    {
        return _oConfigHandler.setParam(oSection, sConfigItem, sConfigValue,
            bMandatory);
    }
    ...
    public void importConfig(File fConfig) throws ASelectConfigException
    {
        ...
        else
        {
            _oSystemLogger.log(Level.WARNING, 
                MODULE, sMethod, "File object is null.");
    ...
    private IConfigHandler resolveConfigHandler(File fConfig)
    {
        ...
        {
            _oSystemLogger.log(Level.SEVERE, 
                MODULE, sMethod, "Filename is null.");
        }
        //resolve extension
