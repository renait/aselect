...
public class CrossASelectManager
{
        ...
        throws ASelectConfigException
    {
        ...
        catch (ASelectConfigException e)
        {
            _systemLogger.log(Level.WARNING, MODULE, sMethod, 
                "No 'aselect' config section found", e);
            throw e;
        }
        ...
        try
        {
            ...
            catch (ASelectConfigException eAC)
            {
                StringBuffer sbMessage = new StringBuffer(
                    "No valid 'organization' section found for '");
    ...
    public String getLocalParam(String sOrgId, String sName)
    {
        ...
        try
        {
            try
            {
                oLocalOrg = _oASelectConfigManager.getSection(
                    _oLocalConfigSection, "organization", "id=" + sOrgId);
            }
            catch (ASelectConfigException eAC)
            {
                StringBuffer sbMessage = new StringBuffer(
    ...
    throws ASelectException
    {
        ...
        {
            StringBuffer sbMessage = new StringBuffer(
                "No valid 'organisation' section found for '");
    ...
    public String getHandlerConfig(String sKey)
    {
        ...
        try
        {
            sValue = _oASelectConfigManager.getParam(
                _oHandlerConfigSection, sKey);
        }
        catch(ASelectConfigException ace)
        {
            _systemLogger.log(Level.FINE, MODULE, sMethod, 
                "No handler configuration found", ace);
            sValue = "";
        }
        return sValue;
    }
        ...
        throws ASelectException
    {
        ...
        try
        {
            ...
            // defined
            oLocalServer = _oASelectConfigManager.getSection(_oLocalConfigSection,
                "organization");
        }
        catch (ASelectConfigException eAC)
        {
        ...
        try
        {
            String sRequireSigning = _oASelectConfigManager.getParam(
                _oLocalConfigSection, "require_signing");
        ...
        while (oLocalServer != null)
        {
            ...
            try
            {
                String sForced = _oASelectConfigManager.getParam(oLocalServer
                    , "forced_authenticate");
        ...
        throws ASelectException
    {
        ...
        try
        {
            String sUseSigning = _oASelectConfigManager.getParam(
                _oRemoteConfigSection, "sign_requests");
        ...
        throws ASelectException
    {
        ...
        try
        {
            ocross_selector_ConfigSection = _oASelectConfigManager.getSection(
                _oCrossConfigSection, "cross_selector");
        }
        catch (ASelectConfigException e)
        {
        ...
        try
        {
            String sHandlerName = _oASelectConfigManager.getParam(
                ocross_selector_ConfigSection, "handler");
            _oHandlerConfigSection = _oASelectConfigManager.getSection(
                ocross_selector_ConfigSection, "handler", "id=" + sHandlerName);
        ...
        {
            _systemLogger.log(Level.WARNING, MODULE, sMethod,
                "Failed to initialize cross_selector: ", e);
            throw e;
        }        
        catch (Exception e)
        {
        ...
        throws ASelectException
    {
        ...
        try
        {
            ...
            String sKeystoreName = new StringBuffer(sWorkingDir).
                append(File.separator).
                append("keystores").
                append(File.separator).
                append("cross").
                append(File.separator).
                append("local_servers.keystore").
                toString();
            ...
            try
            {
                oLocalServer = _oASelectConfigManager.getSection(
                    _oLocalConfigSection, "organization");
            }
            catch (ASelectConfigException e)
            {}
            while (oLocalServer != null)
            {
                String sOrgID = _oASelectConfigManager.getParam(
                    oLocalServer, "id");
                _htLocalServerPublicKeys.put(sOrgID.toLowerCase(),
                    loadPublicKeyFromKeystore(sKeystoreName, sOrgID));
                oLocalServer = _oASelectConfigManager
                    .getNextSection(oLocalServer);
            }
        }
        catch (ASelectConfigException ace)
        {
            _systemLogger.log(Level.WARNING, MODULE, sMethod, 
                "Failed to load configuration of local servers.", ace);
            throw ace;
        }
        catch (ASelectException ae)
        {
            _systemLogger.log(Level.WARNING, MODULE, sMethod, 
                "Failed to load public keys of local servers.", ae);
            throw ae;
        }
    }
