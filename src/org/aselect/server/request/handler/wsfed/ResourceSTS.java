...
public class ResourceSTS extends ProtoRequestHandler
{
	...
	throws ASelectException
	{
		...
		try {
			...
			if (sPwctx != null)
				sbRedirect.append("&wctx=").append(URLEncoder.encode(sPwreply, "UTF-8"));
			if (sPwtrealm != null)
	...
	// <wst:RequestedSecurityToken><saml:Assertion AssertionID="_5f01741c-add2-40bb-b3f3-1214cd90700f"
	// IssueInstant="2007-07-11T22:51:15Z" Issuer="urn:federation:adatum" MajorVersion="1" MinorVersion="1"
	...
	// </saml:Conditions>
	// <saml:Advice><adfs:CookieInfoHash
	// xmlns:adfs="urn:microsoft:federation">sU1g1W6FUmfptr+fZiSmY8C6G9Q=</adfs:CookieInfoHash></saml:Advice>
	// <saml:AuthenticationStatement AuthenticationInstant="2007-07-11T22:51:15Z"
	// AuthenticationMethod="urn:federation:authentication:windows">
	// <saml:Subject><saml:NameIdentifier
	// Format="http://schemas.xmlsoap.org/claims/UPN">Administrator@adatum.com</saml:NameIdentifier></saml:Subject></saml:AuthenticationStatement>
	...
	// URI="#_5f01741c-add2-40bb-b3f3-1214cd90700f">
	...
	// </Signature></saml:Assertion></wst:RequestedSecurityToken><wsp:AppliesTo
