...
//    	HashMap htCredentialsParams = getCredentialsFromCookie(request);
		...
		handleShowForm(_sTemplate, sPwhr, sActionUrl, sPwctx, sReplyTo,
				Tools.samlCurrentTime(), sASelectURL, sRid, _sASelectServerID, response);
	...
	throws ASelectException
	{
		...
		try {
			...
			HandlerTools.putCookieValue(response, SESSION_ID_PREFIX+"realm", sAudience, _sCookieDomain, -1, _systemLogger);
