...
public class RequestHandlerFactory
{
        ...
        HttpServletResponse servletResponse)throws ASelectCommunicationException
    {
        ...
        _systemLogger.log(Level.INFO, MODULE, sMethod, "HANDLER Orig="+(
                ...
                (orig==RequestParser.ORIGIN_USER)?"USER":"INVALID")+
        		", type="+((reqParser.getRequestType() == RequestParser.REQTYPE_API_CALL)? "API": "BROWSER")+
        		", method="+servletRequest.getMethod()+
        		", req="+servletRequest.getParameter("request"));
