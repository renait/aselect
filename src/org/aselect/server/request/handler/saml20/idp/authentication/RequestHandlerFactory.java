 ...
 * implementations. The factory uses a {@link RequestParser} to determine the
 * type of request handler and constructs this type of handler. <br>
 * <br>
 * <b>Concurrency issues:</b> <br>
 * The class is a singleton, so the same class is used in all the classes of the
 * A-Select Server. <br>
 * 
 * @author Alfa & Ariss
 */
...
{
	/** The module name */
	private final String MODULE = "xxx_RequestHandlerFactory";
	 ...
	 * constructs this type of handler. <br>
	 * <br>
	 * <b>Concurrency issues:</b> <br> - <br>
	 * <br>
	 * <b>Preconditions:</b>
	 ...
	 *             If communication failed and no response was sent to the
	 *             client yet.
	 */
