 ...
 * <br>
 * <b>Description:</b> <br>
 * If this A-Select Servers is acting as Remote Server for other A-Select
 * Servers (cross A-Select), the following requests of Local Servers are handled
 * here:
 * <ul>
...
public class ASelectAPIHandler extends AbstractAPIRequestHandler
{
		...
		throws ASelectException
	{
		...
		_systemLogger.log(Level.INFO, _sModule, sMethod, "AselApiREQ " + oInputMessage);
