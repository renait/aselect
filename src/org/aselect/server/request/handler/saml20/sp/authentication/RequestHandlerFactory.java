		...
		throws ASelectCommunicationException
	{
		...
		case RequestParser.ORIGIN_APPLICATION:
			...
			if (reqParser.getRequestType() == RequestParser.REQTYPE_API_CALL)
				try {
					oRequestHandler = new ApplicationAPIHandler(reqParser, servletRequest, servletResponse,
							_sMyServerId, _sMyOrg);
				}
				catch (ASelectException e) {
					throw new ASelectCommunicationException(e.toString());
				}
			else
