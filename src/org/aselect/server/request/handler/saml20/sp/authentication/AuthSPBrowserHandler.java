...
public class AuthSPBrowserHandler extends AbstractBrowserRequestHandler
{
	...
	/**
	 * This function handles the AuthSP response and calls the correct
	 * AuthSP handler. <br>
	 * <br>
	 * 
		...
		throws ASelectException
	{
		...
		try {
			...
			// let the AuthSP protocol handler verify the response from the
			// AuthSP
	 ...
	 * application. The application will receive the error code specified in
	 * the API call. <br>
	 * <br>
	 * 
	 * @param htServiceRequest
