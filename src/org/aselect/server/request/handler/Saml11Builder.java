...
//				+ oSAMLAuthenticationStatement);
		...
		_systemLogger.log(Level.FINEST, MODULE, sMethod, "SAML htAttributes=" + Auxiliary.obfuscate(htAttributes));
		if (_bSendAttributeStatement) {
			_systemLogger.log(Level.FINEST, MODULE, sMethod, "sUid=" + Auxiliary.obfuscate(sUid));
	...
	throws ASelectException
	{
		...
		try {
			_systemLogger.log(Level.FINEST, MODULE, sMethod, "IDENT Uid=" + Auxiliary.obfuscate(sUid) + " ServerID=" + _sASelectServerID);
...
//			_systemLogger.log(Level.FINER, MODULE, sMethod, "AUTH oSAMLSubject=" + oSAMLSubject);
	...
	throws ASelectException
	{
		...
		try {
			...
			_systemLogger.log(Level.FINEST, MODULE, sMethod, "htAttributes=" + Auxiliary.obfuscate(htAttributes));
