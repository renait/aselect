 ...
 * <code>SAML11ArtifactRequestHandler</code> and the 
 * <code>BrowserArtifact</code> WebSSO profile.
 * <br><br>
...
public class AssertionSessionManager extends StorageManager
{
     ...
     * -
     * <br>
     * @param oConfig Containing the Storage manager configuration
     * @throws ASelectStorageException if initalization fails
     */
    public void init(Object oConfig) throws ASelectStorageException
    {
        String sMethod = "init()";
        try
        {
     ...
     * <b>Description:</b>
     * <br>
     * Creates a new instance of this object if 
     * <code>_oAssertionSessionManager</code> is <code>null</code>
     * <br><br>
     * <b>Concurrency issues:</b>
     * <br>
     * -
     ...
     * <b>Description:</b>
     * <br>
     * <li>Verifies if the SAML Artifact already is stored</li>
     * <li>Stored the SAMLAssertion object with key=Artifact</li>
     * <br><br>
     * <b>Concurrency issues:</b>
     * <br>
     * -
     ...
     * <b>Preconditions:</b>
     * <br>
     * <li>oArtifact != null</li>
     * <li>oSAMLAssertion != null</li>
     * <br><br>
     * <b>Postconditions:</b>
     * <br>
     * -
     * <br>
     * @param oArtifact SAML Artifact used as key
     * @param oSAMLAssertion SAMLAssertion used as value
     * @throws ASelectException if storing failed
     */
    	...
    	throws ASelectException
    {
        ...
        try
        {
            ...
            if (containsKey(oArtifact))
            {
                _systemLogger.log(Level.WARNING, MODULE, sMethod, 
                    "Session already exists with id: " + oArtifact.toString());
            ...
            catch (ASelectStorageException e)
            {
                ...
                {
                    _systemLogger.log(Level.WARNING, MODULE, sMethod, 
                        "Maximum number of request sessions reached", e);
        ...
        {
            _systemLogger.log(Level.SEVERE, MODULE, sMethod
                , "Could not create session with session id: " + oArtifact.toString(), e);
            throw new ASelectStorageException(Errors.ERROR_ASELECT_INTERNAL_ERROR, e);
        }
    }
     ...
     * <b>Description:</b>
     * <br>
     * Returns the SAMLAssertion from the Session Manager that is indexed by the 
     * supplies SAMLArtifact.
     * <br><br>
     * <b>Concurrency issues:</b>
     * <br>
     * -
     ...
     * -
     * <br>
     * @param oArtifact SAMLArtifact object
    ...
    public SAMLAssertion getAssertion(Artifact oArtifact) 
    {
	    ...
	    {
	        _systemLogger.log(Level.WARNING, MODULE, sMethod
	            , "No session context with id: " + oArtifact.toString(), e);
	    }
    ...
    /**
     * Private constructor for singleton perposes
     * <br><br>
     */
