...
public interface IRequestHandler
{
     ...
     * -
     * <br>
     * @param oServletConfig Servlet Config of the Parent servlet
     * @param oConfig Object containing the RequestHandler configuration
     ...
     * <b>Description:</b>
     * <br>
     * Processes the request from the <code>HttpServletRequest</code> and sends 
     * the response to the <code>HttpServletResponse</code>
     * <br><br>
     * <b>Concurrency issues:</b>
     * <br>
     * -
     ...
     * @param response HttpServletResponse containing the response
     * @return RequestState containing the request handling state
     * @throws ASelectException if the request couldn't be processed
     */
