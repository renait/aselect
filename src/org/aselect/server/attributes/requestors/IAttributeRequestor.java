 ...
 * <br>
 * The <code>AttributeGatherer</code> instantiates each
 * configured Attribute Requestor, invokes its <code>
 * getAttributes()</code> method, and processes the result.
...
public interface IAttributeRequestor
{
     ...
     * @param oConfig The configuration section to use.
     * @throws ASelectException If configuration fails.
     */
     ...
     * <b>Description:</b>
     * <br>
     * Retrieve all known attributes or attributes that are specified in 
     * <code>vAttributes</code>.
     * <br><br>
     * <b>Concurrency issues:</b>
     * <br>
     ...
     * 	<li>
     * 		The attribute requestor must be able to map all attributes 
     * 		in <code>vAttributes</code>.
     * 	</li> 
     * </ul>
     * <br>
     * <b>Postconditions:</b>
     ...
     * @param vAttributes The attributes to gather.
     ...
     * <b>Postconditions:</b>
     * <br>
     * The <code>IAttributeRequestor</code> implementation is stopped.
     * <br>
     * 
     */
    public void destroy();
