...
public abstract class SamlArtifactResolver extends ProtoRequestHandler
{
	...
	throws ASelectException
	{
		...
		try {
			 ...
			 * xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"> <soap:Header/><soap:Body> <samlp:Request
			 * xmlns="urn:oasis:names:tc:SAML:1.0:protocol" xmlns:saml="urn:oasis:names:tc:SAML:1.0:assertion"
			 * xmlns:samlp="urn:oasis:names:tc:SAML:1.0:protocol" xmlns:xsd="http://www.w3.org/2001/XMLSchema"
			 * xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" IssueInstant="2007-05-18T18:49:34.509Z"
			 * MajorVersion="1" MinorVersion="1" RequestID="_e63dcb72fb3cde38e64baa0eaf01a43d">
			 * <samlp:AssertionArtifact>
			 * AAOlm3kq8uJpt8B900hxPdw/0BvHmsgRIMgJH4i2U2JeaNmDO62lQJTf</samlp:AssertionArtifact> </samlp:Request>
			 * </soap:Body></soap:Envelope>
			 */
			/*
			 * // Debugging: int c; String input; ServletInputStream in = request.getInputStream(); for (input = "" ; ;
			 * ) { c = in.read(); if (c < 0) break; input = input + (char)c; }
			...
			oSAMLResponse = new SAMLResponse(oSAMLRequest.getId() /* inResponseTo */, null /* recipient */,
			...
			Tools.addAttributeToElement(n, _systemLogger, "Assertion", "xmlns:xsi",
