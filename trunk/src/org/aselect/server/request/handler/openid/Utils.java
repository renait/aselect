...
public abstract class Utils
{
	private final static String MODULE = "Utils";
	  ...
	  public static void sendDiscoveryResponse(HttpServletResponse response , String message, ASelectSystemLogger _systemLogger) throws IOException {
	  ...
	  public static void logRequestParameters(ParameterList request, ASelectSystemLogger _systemLogger) {
		...
		_systemLogger.log(Level.INFO, MODULE, sMethod, "Dumping request parameters:");
		if (request != null) {
			List<Parameter> paramList = request.getParameters();
			for (Parameter parameter : paramList) {
				_systemLogger.log(Level.INFO, MODULE, sMethod, "Parameter:" + parameter.getKey() + ":" + parameter.getValue());
			}
		} else {
			_systemLogger.log(Level.INFO, MODULE, sMethod, "Parameterlist empty");
		}
		_systemLogger.log(Level.INFO, MODULE, sMethod, "End dumping request parameters");
	  }
