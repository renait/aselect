...
public abstract class AbstractBrowserRequestHandler implements IRequestHandler
{
	 ...
	 * <br>
	 * 
	 * @see org.aselect.server.request.handler.saml20.idp.authentication.IRequestHandler#processRequest()
	 */
	...
	protected void showErrorPage(String sErrorCode, Hashtable htServiceRequest, PrintWriter pwOut)
	{
		...
		try {
			...
			/*
			 * TODO Duplicate code 12-10-07 HW Hashtable htSession = null; if
			 * (sRid != null) htSession =
			 * SessionManager.getHandle().getSessionContext(sRid); sErrorForm =
			 * _configManager.updateTemplate(sErrorForm, htSession);
			 */
