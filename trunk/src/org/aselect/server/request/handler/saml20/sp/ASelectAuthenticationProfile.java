package org.aselect.server.request.handler.saml20.sp;
...
import org.aselect.server.request.handler.saml20.sp.authentication.IRequestHandler;
import org.aselect.server.request.handler.saml20.sp.authentication.RequestHandlerFactory;
 ...
 * <br>
 * <b>Description:</b><br>
 * The A-Select Server Authentication Profile for legacy A-Select request
 * handlers (> A-Select 1.4).<br>
 * <br>
...
public class ASelectAuthenticationProfile extends AbstractRequestHandler
{
	 ...
	 * </ul>
	 * <br/> Initializes the A-Select Legacy Request Handler factory <br>
	 * <br>
	 * 
	 ...
	 * handler for the supplied request. <br>
	 * <br>
	 * <i>Note: The restart request should be handled by one <code>Servlet</code>
	 * in the context. </i> <br>
	 * <br>
	 * <b>Concurrency issues: </b> <br> - <br>
	 * <br>
		...
		throws ASelectException
	{
		...
		try {
			...
			_systemLogger.log(Level.INFO, MODULE, sMethod, "iHandler=" + iHandler.getClass());
