...
public class SAML11ArtifactRequestHandler extends AbstractRequestHandler
{
     ...
     * <li>searches for an Assertion in the AssertionSessionManager</li>
     * <li>verifies if the Assertion is still valid (checks expire times)</li>
     * <li>signes the SAML response</li>
     * <br><br>
...
//          }
            ...
            while (iterArtifacts.hasNext())
            {
                ...
                if ((lCurrent > lNotBefore) 
                    && (lCurrent <= lNotOnOrAfter))
                {
			...
			oSAMLResponse = new SAMLResponse(oSAMLRequest.getId(), sShire,
