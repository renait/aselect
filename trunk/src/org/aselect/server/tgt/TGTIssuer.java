...
public class TGTIssuer
{
    		...
    		throws ASelectException
    {
        ...
        try
        {
            ...
            String fld = (String)htRemoteAttributes.get("digid_uid");
            if (fld != null) htTGTContext.put("digid_uid", fld);
            fld = (String)htRemoteAttributes.get("digid_betrouwbaarheidsniveau");
            if (fld != null) htTGTContext.put("digid_betrouwbaarheidsniveau", fld);
            // The Saml20 protocol needs a return address:
            fld = (String)htRemoteAttributes.get("sp_assert_url");
     ...
     * @throws ASelectException if an error page must be shown
     */
    public void issueErrorTGT(String sRid, String sResultCode,
     ...
     */
    public void sendRedirect(String sAppUrl, String sTgt, String sRid, 
        	HttpServletResponse oHttpServletResponse)
    	throws ASelectException
    {
