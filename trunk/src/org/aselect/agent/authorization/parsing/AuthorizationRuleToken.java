 ...
 * <br>
 * <b>Description:</b><br>
 * This token can represent different types of tokens from an authorization rule. <br>
 * <br>
...
public class AuthorizationRuleToken
{
	...
	/**
	 * Create a new <code>AuthorizationRuleToken</code>. <br>
	 * <br>
	 * <b>Description:</b> <br>
	 * Create a new <code>AuthorizationRuleToken</code> with the given properties. <br>
	 * <br>
	 * <b>Concurrency issues:</b> <br>
	 * - <br>
	 * <br>
	...
	/**
	 * Convert a <code>String</code> to known Java types. <br>
	 * Tries to create the following objects if <code>oIn</code> is a <code>String</code>:
	 * <ul>
	 ...
	 * </ul>
	 * If no other object can be created <code>oIn</code> is returned. <br>
	 * <b>Preconditions:</b> <br>
	 * <code>oIn != null</code> <br>
	 * <b>Postconditions:</b> <br>
	 * - <br>
	 * <br>
	 * 
	 * @param oIn
	 *            the <code>Object</code> to be converted.
	...
	public static Object convertToKnownType(Object oIn)
	{
		...
		if (oIn instanceof String) // Object is String
		{
			...
			for (int i = 0; i < lc.length; i++) {
				DateFormat oDateTimeFormat = DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT, lc[i]);
				try {
