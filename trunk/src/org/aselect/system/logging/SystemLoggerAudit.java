...
//    }
     ...
     * <li><i>oSystemLoggerAudit</i> may not be <code>null</code></li>
     * <br><br>
     * <b>Postconditions:</b>
     * <br>
...
//        }
    ...
    /**
     * A log formatter for system log items. SystemLogFormatter
     * <br><br>
     * <b>Description: </b> 
     * <br>
    ...
    protected org.apache.log4j.Level mapLevel(Level level) {
    	...
    	if (level.equals(Level.CONFIG)) return org.apache.log4j.Level.WARN;
    		...
    		if (level.intValue() <= Level.FINEST.intValue()) {
        		...
        		if (level.intValue() <= Level.FINE.intValue()) {
	        		...
	        		if (level.intValue() <= Level.INFO.intValue()) {
		        		...
		        		if (level.intValue() <= Audit.AUDIT.intValue()) {
