 ...
 * <br>
 * <b>Description: </b> <br>
 * The SOAP communicator is used to create, retrieve, and send SOAP 1.2 messages. <br>
 * 
...
public class SOAP12Communicator implements IClientCommunicator
{
	...
	/**
	 * Creates a new <code>SOAP12Communicator</code>. <br>
	 * <br>
	 * <b>Preconditions: </b>
	 * <ul>
	 ...
	 * <ul>
	 * <li><code>_systemLogger</code> is set with <code> systemLogger</code>.</li>
	 * <li><code>_sCallMethod</code> is set with <code> sCallMethod</code>.</li>
	 * </ul>
	 * 
	 * @param sCallMethod
	...
	throws ASelectCommunicationException
	{
		...
		try {
			// Send the message
			sResponse = sendTheSoapMessage(sMessage, sTarget);
		}
	...
	private String createMessage(HashMap htParameters, String sTargetUrl)
	{
		...
		// Params and target url may not be empty to create a message
		{
			...
			sbMessage.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n");
			sbMessage.append("<env:Envelope xmlns:env=\"").append(URI_SOAP12_ENV).append("\" ");
			sbMessage.append("xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" ");
			sbMessage.append("xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">\n");
			...
			while (iter.hasNext()) {
				...
				if (oValue instanceof String) {
					...
					sbMessage.append(" enc:itemType=\"xsd:string\" enc:arraySize=\"");
					sbMessage.append(asAtributes.length).append("\" xmlns:enc=\"").append(URI_SOAP12_ENC).append(
							"\">\n");
					for (int i = 0; i < asAtributes.length; i++) {
						sbMessage.append("\t\t\t\t<m:item xsi:type=\"xsd:string\">");
	 ...
	 * <b>Preconditions: </b>
	 * <ul>
	 * <li><code>sMessage</code> should contain a valid SOAP 1.1 message.</li>
	...
	throws java.net.MalformedURLException, ASelectCommunicationException
	{
		...
		try {
			...
			case 200: // ok
			{
				 ...
				 * bytes and put them in a string while ((iRead = isInput.read(ba)) != -1) { //append to stringbuffer
				 * sbBuf.append(new String(ba, 0, iRead)); // clear the buffer Arrays.fill(ba, (byte)0); } //close the
	...
	throws ASelectCommunicationException
	{
		...
		if (elBody != null) {
			...
			nlNodes = elBody.getElementsByTagNameNS(sURI + URI_ASELECT_ENV, _sCallMethod + "Response");
