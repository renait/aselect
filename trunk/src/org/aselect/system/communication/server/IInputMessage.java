 ...
 * <br><br>
 * <b>Description:</b><br>
 * An <code>IInputMessage</code> can be used as an interface to the 
 * internal messages of the {@link IMessageCreatorInterface}.
 * This interface is provided to access the communication in a transparent manner. 
 * <br><br>
 * The <code>IInputMessage</code> interface only specifies methods for retrieving 
...
public interface IInputMessage
{
     ...
     * The parameters are name/value pairs; the name of the value 
     * must be specified.
     * <br><br>
     * <b>Concurrency issues:</b>
     * <br>
     ...
     * @throws ASelectCommunicationException If parameter retrieving fails.
     */
